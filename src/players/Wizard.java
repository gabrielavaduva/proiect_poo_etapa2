...
public class Wizard extends Player {
    public Wizard(final int id, final int x, final int y, final String currentLand) {
        super(id, x, y, currentLand);
        this.setHp(Constants.WI_HP);
        this.setName("W");

        this.setHp(Constants.WI_HP);
        this.setHpBonusLevel(Constants.WI_HP_LEVEL_BONUS);
        this.setSpecificHp(Constants.WI_HP);
    }
    ...
    public void fight(final AbilityVisitor a, final Player enemy) {
        enemy.acceptDrain(a, this);
        enemy.acceptDeflect(a, this);
    }
}
