...
public class Knight extends Player {
    ...
    public Knight(final int id, final int x, final int y, final String currentLand) {
        super(id, x, y, currentLand);
        this.setName("K");
        this.setHp(Constants.KN_HP);

        this.setSpecificHp(Constants.KN_HP);
        this.setHpBonusLevel(Constants.KN_HP_LEVEL_BONUS);
    }
    ...
    public void fight(final AbilityVisitor a, final Player enemy) {
        enemy.acceptExecute(a, this);
        enemy.acceptSlam(a, this);
    }
